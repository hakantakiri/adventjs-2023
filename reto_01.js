...
En otras palabras, si hay más de un número repetido, debes
 devolver el número cuya segunda ocurrencia aparezca primero 
 en la lista. Si no hay números repetidos, devuelve -1.
*/
...
// 260 pts: 3026 ops/s, complexity: 2
...
// 220 pts: 3206 ops/s, complexity: 2
// function findFirstRepeated(gifts) {
//   let seen = new Set()
//   for (const id of gifts) {
//     if (seen.has(id)) {
